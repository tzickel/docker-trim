...
echo "> Running image, press Ctrl-C when done (or finish the container, or kill it from another console)"
STRACE_TMP_FILE="${IMAGE_NAME_ESCAPED}.strace_tmp_file"
...
STRACE_PARSED_TMP_FILE="${IMAGE_NAME_ESCAPED}.strace_parsed_tmp_file"
...
FILE_TMP_FILE="${IMAGE_NAME_ESCAPED}.file_tmp_file"
